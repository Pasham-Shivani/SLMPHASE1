...
public class LockedMe {
	...
	public static void main(String[] args)throws IOException, InterruptedException 
	{
		...
		String st;
		File mFolder =new File("E:\\JavaNewBatch");
		mFolder.mkdir();
		String location = "E:\\JavaNewBatch";
	    ...
	    switch(choice) {
	    case 1:
	    	File Fobj = new File("E:\\JavaNewBatch");
	    ...
	    case 2:
		    ...
		    case 3:
		    	...
		    	st = sc.next();
		    	File fsearch = new File("E:\\JavaNewBatch");
